...
public class CinEditorParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CinEditorGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getItemPositionStringAccess().getAlternatives(), "rule__ItemPositionString__Alternatives");
			...
			builder.put(grammarAccess.getItemPositionIntAccess().getGroup(), "rule__ItemPositionInt__Group__0");
			builder.put(grammarAccess.getItemPositionStringAccess().getGroup_0(), "rule__ItemPositionString__Group_0__0");
			builder.put(grammarAccess.getItemPositionStringAccess().getGroup_1(), "rule__ItemPositionString__Group_1__0");
			builder.put(grammarAccess.getItemPositionStringAccess().getGroup_2(), "rule__ItemPositionString__Group_2__0");
			builder.put(grammarAccess.getItemPositionStringAccess().getGroup_3(), "rule__ItemPositionString__Group_3__0");
			builder.put(grammarAccess.getItemPositionStringAccess().getGroup_4(), "rule__ItemPositionString__Group_4__0");
			...
			builder.put(grammarAccess.getPictureAccess().getBeginTimeAssignment_7(), "rule__Picture__BeginTimeAssignment_7");
			...
			builder.put(grammarAccess.getVideoAccess().getBeginCropTimeAssignment_5(), "rule__Video__BeginCropTimeAssignment_5");
			builder.put(grammarAccess.getVideoAccess().getPositionAssignment_6(), "rule__Video__PositionAssignment_6");
			builder.put(grammarAccess.getVideoAccess().getDimensionAssignment_7(), "rule__Video__DimensionAssignment_7");
			builder.put(grammarAccess.getVideoAccess().getBeginTimeAssignment_9(), "rule__Video__BeginTimeAssignment_9");
			...
			builder.put(grammarAccess.getTranslateAccess().getBeginTimeAssignment_6(), "rule__Translate__BeginTimeAssignment_6");
			builder.put(grammarAccess.getTranslateAccess().getDurationAssignment_8(), "rule__Translate__DurationAssignment_8");
			builder.put(grammarAccess.getTranslateAccess().getElementAssignment_10(), "rule__Translate__ElementAssignment_10");
		}
	}
