...
public class CinEditorParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, CinEditorGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTextAccess().getBeginTimeAssignment_6_1(), "rule__Text__BeginTimeAssignment_6_1");
			builder.put(grammarAccess.getTextAccess().getDurationAssignment_7_1(), "rule__Text__DurationAssignment_7_1");
			builder.put(grammarAccess.getTextAccess().getColorAssignment_8(), "rule__Text__ColorAssignment_8");
			...
			builder.put(grammarAccess.getPictureAccess().getBeginTimeAssignment_6_1(), "rule__Picture__BeginTimeAssignment_6_1");
			builder.put(grammarAccess.getPictureAccess().getDurationAssignment_7_1(), "rule__Picture__DurationAssignment_7_1");
			...
			builder.put(grammarAccess.getRectangleAccess().getBeginTimeAssignment_6_1(), "rule__Rectangle__BeginTimeAssignment_6_1");
