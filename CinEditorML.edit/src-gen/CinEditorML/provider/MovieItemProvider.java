...
/**
 * This is the item provider adapter for a {@link CinEditorML.Movie} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MovieItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Movie_name_feature"),
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Movie"));
	}
	...
	public String getText(Object object) {
		String label = ((Movie) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Movie_type")
