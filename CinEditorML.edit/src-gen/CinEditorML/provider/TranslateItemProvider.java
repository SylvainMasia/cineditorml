...
/**
 * This is the item provider adapter for a {@link CinEditorML.Translate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TranslateItemProvider extends EffectItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Translate) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Translate_type")
				: getString("_UI_Translate_type") + " " + label;
	}
