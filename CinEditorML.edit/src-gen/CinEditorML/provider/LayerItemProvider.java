...
/**
 * This is the item provider adapter for a {@link CinEditorML.Layer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LayerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CinEditorMLPackage.Literals.LAYER__ELEMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(CinEditorMLPackage.Literals.LAYER__ELEMENTS,
				CinEditorMLFactory.eINSTANCE.createPicture()));

		newChildDescriptors.add(createChildParameter(CinEditorMLPackage.Literals.LAYER__ELEMENTS,
				CinEditorMLFactory.eINSTANCE.createVideo()));

		newChildDescriptors.add(createChildParameter(CinEditorMLPackage.Literals.LAYER__ELEMENTS,
				CinEditorMLFactory.eINSTANCE.createFadeIn()));

		newChildDescriptors.add(createChildParameter(CinEditorMLPackage.Literals.LAYER__ELEMENTS,
				CinEditorMLFactory.eINSTANCE.createFadeOut()));

		newChildDescriptors.add(createChildParameter(CinEditorMLPackage.Literals.LAYER__ELEMENTS,
				CinEditorMLFactory.eINSTANCE.createTranslate()));
